...
class SoundAiListPage extends StatefulWidget {
  const SoundAiListPage({super.key});

  @override
  State<SoundAiListPage> createState() => _SoundAiListPageState();
}

class _SoundAiListPageState extends State<SoundAiListPage> {
  List<AiInfo> _aiList = [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('音をつくるAI 一覧')),
      body: _loading
