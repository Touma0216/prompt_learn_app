...
class ImageAiListPage extends StatefulWidget {
  const ImageAiListPage({super.key});

  @override
  State<ImageAiListPage> createState() => _ImageAiListPageState();
}

class _ImageAiListPageState extends State<ImageAiListPage> {
  List<AiInfo> _aiList = [];
