...
class TextAiListPage extends StatefulWidget {
  const TextAiListPage({super.key});

  @override
  State<TextAiListPage> createState() => _TextAiListPageState();
}

class _TextAiListPageState extends State<TextAiListPage> {
  List<AiInfo> _aiList = [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('文章をつくるAI 一覧')),
      body: _loading
